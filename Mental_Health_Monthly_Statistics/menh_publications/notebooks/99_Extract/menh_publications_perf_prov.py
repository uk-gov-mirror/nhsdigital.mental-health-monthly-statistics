...
df_mhsds_monthly_csv = spark.sql("""SELECT DISTINCT 
                              ...
                              AND (MONTH_ID <= '1512' OR (MONTH_ID >= '1513' AND MEASURE_ID NOT IN ('EIP64','EIP64a','EIP64b','EIP64c','EIP65','EIP65a','EIP65b','EIP65c','EIP66','EIP66a','EIP66b','EIP66c','EIP67','EIP67a','EIP67b','EIP67c','EIP69a','EIP69b')))  

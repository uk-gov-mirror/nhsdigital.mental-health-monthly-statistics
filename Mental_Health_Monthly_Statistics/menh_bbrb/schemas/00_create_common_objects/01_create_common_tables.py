...
# COMMAND ----------
 ...
 %md
 ###Tables for Referral Spells: CYP Pathways

# COMMAND ----------

 %sql
 DROP TABLE IF EXISTS $db_output.pathway_desc;
 CREATE TABLE IF NOT EXISTS $db_output.pathway_desc
 (
 Pathway STRING,
 PathwayDesc STRING,
 FirstMonth INT,
...
# COMMAND ----------
 ...
 %sql
 TRUNCATE TABLE $db_output.pathway_desc;
 INSERT INTO $db_output.pathway_desc VALUES
 ("a","Spells with at least one referral with a primary reason for referral - Gender Discomfort issues",1500,null),
 ("b","Spells with at least one referral with a primary reason for referral - Neurodevelopmental Conditions, excluding Autism or a referral to a Neurodevelopmental Team",1500,null),
 ("c","Spells with at least one referral with a primary reason for referral - Suspected Autism or Diagnosed Autism or a referral to an Autism Service",1500,null),
 ("d","Spells with at least one 'other' referral not identified as related to autism, neurodevelopmental or gender identity",1500,null),
 ("e","Spells with at least one referral identified as related to autism, neurodevelopmental or gender identity; and at least one 'other' referral not identified as related to autism, neurodevelopmental or gender identity",1500,null)

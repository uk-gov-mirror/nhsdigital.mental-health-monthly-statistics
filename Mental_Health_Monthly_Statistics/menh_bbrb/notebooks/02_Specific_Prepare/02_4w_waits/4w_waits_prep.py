...
# COMMAND ----------
 ...
 CREATE OR REPLACE TEMPORARY VIEW CYP_SPELL_REF_PATHWAYS AS
 SELECT a.*,
 ...
 FROM LATEST_PRFR AS a
 INNER JOIN CYP_SPELL_REF AS b
...
# COMMAND ----------
 ...
 CREATE OR REPLACE TABLE $db_output.cyp_4ww_spell_long_pathways AS 
 SELECT a.*, 
 ...
 FROM $db_output.cyp_4ww_spell_master_long AS a
 LEFT JOIN CYP_SPELL_PATHWAYS_MAX AS b
 ON a.SpellID == b.SpellID
...
# COMMAND ----------
 ...
 %sql
 INSERT OVERWRITE TABLE $db_output.cyp_4ww_spell_master_long_pathway
 ...
 FROM $db_output.cyp_4ww_spell_long_pathways

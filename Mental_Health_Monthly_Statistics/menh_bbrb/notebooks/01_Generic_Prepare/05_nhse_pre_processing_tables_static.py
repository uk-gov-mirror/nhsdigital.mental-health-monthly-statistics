...
# COMMAND ----------
 ...
 AND GP.UniqMonthID in (select distinct UniqMonthID from current_fy_header_uniqmonthids) 
...
# DBTITLE 1,Insert Unique Assessments out of Month in FY - for Outcomes
 %sql
...
# DBTITLE 1,Insert Unique and Valid Assessments in FY - for Outcomes

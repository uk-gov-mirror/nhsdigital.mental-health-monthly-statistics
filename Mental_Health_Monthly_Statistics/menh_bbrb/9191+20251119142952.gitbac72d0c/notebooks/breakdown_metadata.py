...
pathway_bd = {
    "breakdown_name": "England; Pathway",
    "level_tier": 0,
    "level_tables": ["pathway_desc"],
    "primary_level": F.col("Pathway"),
    "primary_level_desc": F.col("PathwayDesc"),
    "secondary_level": F.lit("NONE"),
    "secondary_level_desc": F.lit("NONE"),
    "level_list" : [],
  "lookup_col" : ["Pathway", "PathwayDesc"],
  "level_fields" : [
    F.lit("England; Pathway").alias("breakdown"),
    F.col("Pathway").alias("primary_level"),
    F.col("PathwayDesc").alias("primary_level_desc"),
    F.lit("NONE").alias("secondary_level"), 
    F.lit("NONE").alias("secondary_level_desc")
  ],  
}
...
#4ww_Measures
prov_pathway_bd = cross_dict([prov_bd, pathway_bd])
...
#4ww_Measures
ccg_prac_res_pathway_bd = cross_dict([ccg_prac_res_bd, pathway_bd])
...
#4ww_Measures
stp_prac_res_pathway_bd = cross_dict([stp_prac_res_bd, pathway_bd])
...
#4ww_Measures
comm_region_pathway_bd = cross_dict([comm_region_bd, pathway_bd])

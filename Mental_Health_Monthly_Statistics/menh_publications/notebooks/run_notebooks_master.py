...
# COMMAND ----------
 ...
 %py
 # Set variable month_id_chgover for month of implementation of new CYP methodology and for ED32 metric in EIP
  
 month_id_chgover = '1513'
 assert month_id_chgover
  ...
  for run in jobs:
    ...
    if not product:
      ...
      for row in rows:
        ...
        if (row_product == 'CYP_ED_WaitingTimes_preFY2324' and month_id >= month_id_chgover):
          run = 0
        elif ((row_product == 'CYP_ED_WaitingTimes' or row_product == 'CYP_ED_WaitingTimes_12m') and month_id < month_id_chgover):
          run = 0
      ...
      run_product = product
      if (product == 'CYP_ED_WaitingTimes' and month_id < month_id_chgover):

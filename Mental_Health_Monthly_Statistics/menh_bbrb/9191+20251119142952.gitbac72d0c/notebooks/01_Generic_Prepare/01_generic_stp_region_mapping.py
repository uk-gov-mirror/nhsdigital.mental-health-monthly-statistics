...
# dbutils.widgets.text("reference_db", "reference_db")
...
print(db_output, db_source, status, pub_month,reference_db,rp_enddate)
...
# COMMAND ----------
 ...
 -- inner join $reference_db.ONS_CHD_GEO_EQUIVALENTS geo_ccg
 -- on stp_map.ccg_code = geo_ccg.DH_GEOGRAPHY_CODE
 -- inner join $reference_db.ONS_CHD_GEO_EQUIVALENTS geo_stp
 -- on stp_map.stp_code = geo_stp.DH_GEOGRAPHY_CODE
 -- inner join $reference_db.ONS_CHD_GEO_EQUIVALENTS geo_region

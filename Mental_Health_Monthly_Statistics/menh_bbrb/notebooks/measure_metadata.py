...
four_ww_measure_ids = {
  ...
  "filter_clause": "",
  "aggregate_field": "COUNT(DISTINCT CASE WHEN PATHWAY_CLOCKSTOP IS NULL AND Spell_Open = 1 THEN SpellID ELSE NULL END)",
  "aggregate_function": produce_date_filter_4ww_agg_df,
  "numerator_id": "MRS09",
  "denominator": 0,  
  "crude_rate": 0,
  "related_to": "patient spells",
...
"MHS108a": {
  "freq": "12M", 
  "name": "Percentage change in number of people accessing community mental health services for adults and older adults with 2 or more care contacts from the previous year's reporting period",
  "source_table": "cmh_rolling_activity",
  "filter_clause": "",
  "aggregate_field": "COALESCE((SUM(NUMERATOR_COUNT) - SUM(HISTORIC_COUNT)) / SUM(HISTORIC_COUNT), 0) * 100",
  "aggregate_function": produce_percentage_change_agg_df,
  "numerator_id": "MHS108",
  "denominator": 0,  
  "crude_rate": 1,
  "related_to": "people",
  "suppression": "percent_change",
  "breakdowns": [eng_bd, stp_prac_res_bd, prov_bd],
  "output_table": "bbrb_final_raw"
},
"MHS124": {
  "freq": "Q", 
...
"MHS95h": {
  "freq": "12M", 
  "name": "Percentage change in CYP aged under 18 supported through NHS funded mental health with at least one contact (12 month rolling) from the previous year's reporting period",
  "source_table": "firstcont_final",
  "filter_clause": "",
  "aggregate_field": "COALESCE((SUM(NUMERATOR_COUNT) - SUM(HISTORIC_COUNT)) / SUM(HISTORIC_COUNT), 0) * 100",
  "aggregate_function": produce_percentage_change_agg_df,
...
"CCR73": {
  ...
  "related_to": "referrals",
  "suppression": "count",
  "breakdowns": [eng_bd, prov_bd, stp_prac_res_bd, ccg_prac_res_bd],
  "output_table": "bbrb_final_raw"
},
"CCR73a": {
  "freq": "M", 
...
"CCR120c": {
  "freq": "M", 
  "name": "Proportion of New Urgent Referrals to Crisis Care teams in reporting period with first face to face contact within 24 hours of referral",
  "source_table": "spells_rates",
  "filter_clause": "",
  "aggregate_field": "(COALESCE(SUM(NUMERATOR_COUNT)/SUM(DENOMINATOR_COUNT), 0))*100",
  "aggregate_function": produce_crude_rate_agg_df,

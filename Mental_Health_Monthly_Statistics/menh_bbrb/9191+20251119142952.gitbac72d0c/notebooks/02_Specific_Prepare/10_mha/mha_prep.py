...
# DBTITLE 1,Create MHA_MHS001MPI_LATEST
 ...
 LEFT JOIN
          ...
          WHERE IMD_YEAR = (SELECT MAX(IMD_YEAR) FROM $reference_db.english_indices_of_dep_v02) ) C ON B.LSOA2011 = LSOA_CODE_2011     
...
# COMMAND ----------
 ...
 LEFT JOIN
          (SELECT LSOA_CODE_2011, DECI_IMD, IMD_YEAR
          FROM $reference_db.english_indices_of_dep_v02
          WHERE IMD_YEAR = (SELECT MAX(IMD_YEAR) FROM $reference_db.english_indices_of_dep_v02) ) D ON B.LSOA2011 = LSOA_CODE_2011     
